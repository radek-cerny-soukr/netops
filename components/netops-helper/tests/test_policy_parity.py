...
class PolicyParityTests(unittest.TestCase):
    ...
    def test_vendor_interface_guard_positive_and_negative_corpus(self) -> None:
        positive_cases = (
            ...
            ("cisco_ios", "interface_details", "Ethernet0/0", "Ethernet0/0"),
            ("cisco_ios", "interface_details", "Et15/15", "Ethernet15/15"),
            ("cisco_ios", "interface_errors", "Et0/1", "Ethernet0/1"),
            ("cisco_xe", "interface_details", "Ethernet0/0", "Ethernet0/0"),
            ("cisco_xe", "interface_details", "Et3/3", "Ethernet3/3"),
            ("cisco_xe", "interface_errors", "Ethernet2/1", "Ethernet2/1"),
            (
        ...
        negative_cases = (
            ...
            ("cisco_ios", "interface_details", "Ethernet16/0"),
            ("cisco_ios", "interface_details", "Ethernet0/16"),
            ("cisco_ios", "interface_details", "Ethernet00/0"),
            ("cisco_ios", "interface_details", "Ethernet0/0/0"),
            ("cisco_ios", "interface_details", "Ethernet0/0.1"),
            ("cisco_ios", "interface_details", "ethernet0/0"),
            ("cisco_xe", "interface_details", "Ethernet0/0 counters"),
            ("cisco_xe", "interface_details", "Ethernet1"),
            ("cisco_xe", "interface_errors", "Ethernet0/16"),
